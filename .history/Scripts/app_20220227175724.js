...
(function()
{
    ...
    function DisplayRegisterPage()
    {
        ...
        $("#confirmPassword").focusout(function () {
            ...
            if ($.trim(this.value).length > 0 && this.value != $("#password").value) {
                $("#ErrorMessage").show();
        ...
        //2.a - 2.e Validating all fields
        $("#submitButton").click(function () {

            if ($.trim($("#FirstName").value).length < 3) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("First Name must contain more than 2 characters.");
                $("#FirstName").focus();
                return false;
            }
            else if ($.trim($("#lastName").value).length < 3) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("Last Name must contain more than 2 characters.");
                $("#lastName").focus();
                return false;
            }
            else if ($.trim($("#emailAddress").value).length < 8 || $("#emailAddress").indexOf('@') == -1) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("Email must have character length 8 and should contain '@'.");
                $("#emailAddress").focus();
                return false;
