...
* Edited by     : Taylor Bazouzi, Soumya N.Narayananunni
* Created Date  : 25-FEB-2022
* Description   : Javascript file using Jquery to validate forms
*/
...
(function()
{
    ...
    function CheckLogin()
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            ...
            //2.a Show UserName Span if the user is logged in
            $("#loginUser").show();
            $("#loginUser").text(sessionStorage.getItem("user").split(",")[0]);    
            ...
            //2.a Hide UserName Span if the user is logged out
            $("#loginUser").hide();
        }
    }
    ...
    function DisplayRegisterPage()
    {
        ...
        //2.c user enters their First Name and Last Name that the minimum length 2
        $("#FirstName").focusout(function () {
            if ($.trim(this.value).length < 3) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("First Name must contain more than 2 characters.");
        ...
        $("#lastName").focusout(function () {
            if ($.trim(this.value).length < 3) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("Last Name must contain more than 2 characters.");
                this.focus();
                $("#submitButton").prop( "disabled", true );
            }
            else {                
        ...
        //2.d Email Validation
        $("#emailAddress").focusout(function () {
            
            if ($.trim(this.value).length < 8 || this.value.indexOf('@') == -1) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("Email must have character length 8 and should contain '@'.");
                this.focus();
                $("#submitButton").prop( "disabled", true );
            }
            else {                
        ...
        //2.e Password Validation
        $("#password").focusout(function () {
            
            if ($.trim(this.value).length < 6) {
                $("#ErrorMessage").show();
                $("#ErrorMessage").text("Password must have min 6 characters.");
                this.focus();
                $("#submitButton").prop( "disabled", true );
            }
            else {                
        ...
        //2.e Confirm Password Validation
        ...
        $('#submitButton').click(function (e) {
            //2.f - button prevent the default form behaviour
            e.preventDefault();
            //2.h - create an instance of the User class and display it in the console
            let user = new User(
    ...
    //2.g User Class. Create a JavaScript Class named User
    class User{
    ...
    function Start()
    {
        ...
        //2.b - Hide Registration Page ErrorMessage Div.
        $("#ErrorMessage").hide();
