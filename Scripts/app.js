...
(function()
{
     ...
     * and returns the data payload to the callback function.
     * @param {string} method 
     * @param {string} url 
    ...
    function DisplayLoginPage()
    {
        ...
        $("#loginButton").on("click", function ()
        {
            ...
            //use jQuery short cut to load the users.json file
            $.get("./Data/users.json", function (data)
            {
                //for every users in the users.json file, loop
                // data is the json file where the user data entered.
                for (const user of data.users)
                {
                    console.log('username.value: ' +user.Username)
                    console.log(' password.value: ' + user.Password)
                    
                    // check if the user name and password entered matches the user data
                    if (username.value == user.Username && password.value == user.Password)
                    {
                        // get the user data from the file and assign it to the empty user object
